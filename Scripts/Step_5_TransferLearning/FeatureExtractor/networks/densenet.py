...
from tensorflow.keras.layers import (
    BatchNormalization, Conv2D, Dense, Input, Activation, 
...
class DenseNet:
    def __init__(self, epochs=250, batch_size=64, load_weights=True):
        self.name               = 'densenet'
        self.model_filename     = 'FeatureExtractor/networks/pretrained_weights/densenet.h5'
        self.growth_rate        = 12 
        self.depth              = 100
        ...
        self.log_filepath       = r'FeatureExtractor/networks/pretrained_weights/densenet/'

        # Cria diretórios se não existirem
        os.makedirs('FeatureExtractor/networks/pretrained_weights', exist_ok=True)
        os.makedirs(self.log_filepath, exist_ok=True)

        # Inicializa o modelo mesmo se não houver pesos pré-treinados
