...
class NetworkInNetwork:
    def __init__(self, epochs=200, batch_size=128, load_weights=True, transfer_learning=False):
        self.name               = 'net_in_net'
        self.model_filename     = 'FeatureExtractor/networks/pretrained_weights/net_in_net.h5'
        self.num_classes        = 10
        ...
        self.dropout            = 0.5
        self.log_filepath       = r'FeatureExtractor/networks/pretrained_weights/net_in_net/'
