...
class WideResNet:
    def __init__(self, epochs=200, batch_size=128, load_weights=True):
        ...
        self.model_filename     = 'FeatureExtractor/networks/pretrained_weights/wide_resnet.h5'
        ...
        self.log_filepath       = r'FeatureExtractor/networks/pretrained_weights/wide_resnet/'
